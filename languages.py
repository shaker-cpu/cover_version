...
❤️ Thank you for choosing us''',
    ...
    'arabic': {
        ...
        # ========== كلمات جديدة لصفحة البرامج الأخرى ==========
        'other_programs': '📦 برامج أخرى',
        'other_programs_title': 'برامجي الأخرى',
        ...
        'update_note': 'ملاحظة: لن يتم تحديث ملفي .gitignore و README.md.',
        ...
        # ========== أزرار إنشاء الغلاف ==========
        'dissertation_cover': 'غلاف\n رسالة',
        'notebook_cover': 'غلاف\n دفتر أو\n عقد',
        'book_cover': 'غلاف\n كتب',
        'gilded_book_cover': 'غلاف\n كتب مذهبة',
        
        # ========== صفحة السمة ==========
        'theme_guide_title': 'دليل إعدادات السمة',
        'theme_guide_message': 'اختر لونًا لتغيير لون جميع الأزرار',
        'background_color': 'لون الخلفية',
        
        # ========== صفحة السجل ==========
        'history_guide_title': 'دليل صفحة السجل',
        'history_guide_message': 'يمكنك رؤية آخر 5 ملفات تم إنشاؤها هنا',
        ...
        # ========== صفحة إنشاء غلاف الرسالة ==========
        'spine_value': 'قيمة العمود الفقري (ملم):',
        'title_text': 'العنوان:',
        ...
        # ========== الأشهر ==========
        'months': ['فروردين', 'أرديبهشت', 'خرداد', 'تير', 'مرداد', 'شهريور',
                   'مهر', 'آبان', 'آذر', 'دي', 'بهمن', 'إسفند'],
        
        # ========== عدد الصفحات ==========
        'pages': ['١ صفحة', '٢ صفحتان', '٣ صفحات', '٤ صفحات', '٥ صفحات'],
        
        # ========== رسالة الترحيب ==========
        'welcome_message': '''بسم الله الرحمن الرحيم
مرحبًا بكم في برنامج صانع الأغلفة
لإنشاء أي نوع من الأغلفة، انقر على الزر المناسب''',
        
        # ========== معلومات عنا ==========
        'about_us': '''📱 صانع الأغلفة

المطوران: السيدان مقيسة و شاكر
...
⭐ تم تصميم هذا البرنامج لإنشاء أنواع مختلفة من الأغلفة.

❤️ مع الشكر لاختياركم''',
    },
    ...
    'chinese': {
        ...
        'start_update': '开始更新',
        'checking': '正在检查...',
        'connecting_github': '正在连接到 GitHub...',
        'github_connection_error': '连接到 GitHub 时出错',
        'app_up_to_date': '您的应用程序是最新的',
        'new_version_available': '新版本 {} 可用',
        'new_version_found': '发现新版本',
        'update_question': '您想要更新吗？',
        'update_note': '注意：.gitignore 和 README.md 文件不会被更新。',
        'updating': '正在更新...',
        'downloading_updating': '正在下载和更新...',
        'update_successful': '更新成功 (版本 {})',
        'update_successful_title': '更新成功',
        'update_successful_message': '应用程序成功更新至版本',
        ...
        # ========== 封面按钮 ==========
        'dissertation_cover': '制作\n论文封面',
        'notebook_cover': '制作\n学校笔记本或\n合同封面',
        'book_cover': '制作\n书籍封面',
        'gilded_book_cover': '制作\n烫金\n书籍封面',
        
        # ========== 主题页面 ==========
        'theme_guide_title': '应用程序主题设置指南',
        'theme_guide_message': '选择一种颜色来更改所有按钮的颜色',
        'background_color': '背景颜色',
        
        # ========== 历史记录页面 ==========
        'history_guide_title': '历史记录页面指南',
        'history_guide_message': '您可以在此处查看最近创建的 5 个文件',
        ...
        'logo_black_white': '论文徽标是黑白的',
        'logo_black_white_on': '黑白',
        'logo_black_white_off': '彩色',
        'logo_circular': '论文徽标是圆形的',
        'logo_circular_on': '圆形',
        ...
        # ========== 月份 ==========
        'months': ['法尔瓦尔丁', '奥尔迪贝赫什特', '霍尔达德', '蒂尔', '莫尔达德', '沙赫里瓦尔',
                   '梅赫尔', '阿班', '阿扎尔', '戴伊', '巴赫曼', '埃斯凡德'],
        
        # ========== 页数 ==========
        'pages': ['1 页', '2 页', '3 页', '4 页', '5 页'],
        
        # ========== 开始指南 ==========
        'welcome_message': '''奉至仁至慈的真主之名
欢迎使用封面制作程序
要制作任何类型的封面，请点击相应的按钮''',
...
❤️ 感谢您的选择''',
    ...
    'russian': {
        ...
        'update_successful_message': 'Программа успешно обновлена до версии',
        'restart_question': 'Для применения изменений программу необходимо перезапустить. Хотите перезапустить сейчас?',
        'restarting': 'Перезапуск...',
        'update_error': 'Ошибка обновления',
        'restart_error': 'Ошибка перезапуска',
        'update': 'Обновить',
        
        # ========== Кнопки создания обложек ==========
        'dissertation_cover': 'Создать обложку\n диссертации',
        'notebook_cover': 'Создать обложку\n школьной тетради\n или договора',
        'book_cover': 'Создать обложку\n книги',
        'gilded_book_cover': 'Создать обложку\n для книг\n с позолотой',
        
        # ========== Страница темы ==========
        'theme_guide_title': 'Руководство по настройке темы',
        'theme_guide_message': 'Выберите один из цветов, чтобы изменить цвет всех кнопок программы',
        'background_color': 'Цвет фона',
        
        # ========== Страница истории ==========
        'history_guide_title': 'Руководство по странице истории',
        'history_guide_message': 'На этой странице вы можете увидеть последние 5 созданных файлов',
        ...
        'step3': 'Шаг 3',
        'step4': 'Шаг 4',
        'help_plan_1': 'Руководство к первому шагу',
        'help_plan_2': 'Руководство ко второму шагу',
        'help_plan_3': 'Руководство к третьему шагу',
        'help_plan_4': 'Руководство к четвертому шагу',
        
        # ========== Страница создания обложки диссертации ==========
        ...
        # ========== Флажки ==========
        'has_latin_page': 'Диссертация имеет страницу на латинице',
        'has_latin_page_on': 'Имеет страницу на латинице',
        'has_latin_page_off': 'Без страницы на латинице',
        'logo_black_white': 'Логотип диссертации черно-белый',
        'logo_black_white_on': 'Черно-белый',
        'logo_black_white_off': 'Цветной',
        'logo_circular': 'Логотип диссертации круглый',
        'logo_circular_on': 'Круглый',
        'logo_circular_off': 'Некруглый',
        
        # ========== Кнопки действий ==========
        'refresh': 'Очистить страницу',
        ...
        # ========== Месяцы ==========
        'months': ['Фарвардин', 'Ордибехешт', 'Хордад', 'Тир', 'Мордад', 'Шахривар',
                   'Мехр', 'Абан', 'Азар', 'Дей', 'Бахман', 'Эсфанд'],
        
        # ========== Количество страниц ==========
        'pages': ['1 страница', '2 страницы', '3 страницы', '4 страницы', '5 страниц'],
        
        # ========== Вступительное руководство ==========
        'welcome_message': '''Во имя Аллаха, Милостивого, Милосердного
Добро пожаловать в программу создания обложек
Для создания любого типа обложки нажмите соответствующую кнопку''',
        
        # ========== О нас ==========
        'about_us': '''📱 Программа создания обложек

Разработчики: Господа Могисе и Шакер

📅 Версия: ۱.۰.۰

📧 Поддержка: support@example.com

📞 Телефон: ۰۲۱-۱۲۳۴۵۶۷۸

⭐ Эта программа предназначена для создания различных типов обложек.

❤️ Благодарим за ваш выбор''',
    },
    ...
    'spanish': {
        ...
        'app_up_to_date': 'Su aplicación está actualizada',
        'new_version_available': 'Nueva versión {} disponible',
        'new_version_found': 'Nueva versión',
        'update_question': '¿Quiere actualizar?',
        ...
        'restart_question': 'Para aplicar los cambios, la aplicación debe reiniciarse. ¿Quiere reiniciar ahora?',
        'restarting': 'Reiniciando...',
        'update_error': 'Error en la actualización',
        'restart_error': 'Error al reiniciar',
        'update': 'Actualizar',
        
        # ========== Botones de creación de portadas ==========
        'dissertation_cover': 'Crear portada\n de tesis',
        'notebook_cover': 'Crear portada\n de cuaderno escolar\n o contratos',
        'book_cover': 'Crear portada\n de libros',
        'gilded_book_cover': 'Crear portada\n de libros\n con dorado',
        
        # ========== Página de tema ==========
        'theme_guide_title': 'Guía de configuración del tema',
        'theme_guide_message': 'Seleccione un color para cambiar el color de todos los botones',
        'background_color': 'Color de fondo',
        
        # ========== Página de historial ==========
        'history_guide_title': 'Guía de la página de historial',
        'history_guide_message': 'En esta página puede ver los últimos 5 archivos creados',
        ...
        # ========== Página de creación de portada de tesis ==========
        ...
        'no_logo_selected': 'No se ha seleccionado ningún logotipo',
        'file_selected': 'Archivo seleccionado',
        'folder_selected': 'Carpeta seleccionada',
        'logo_selected': 'Logotipo seleccionado',
        
        # ========== Casillas de verificación ==========
        'has_latin_page': 'La tesis tiene página en latín',
        'has_latin_page_on': 'Tiene página en latín',
        'has_latin_page_off': 'Sin página en latín',
        'logo_black_white': 'El logotipo de la tesis es en blanco y negro',
        'logo_black_white_on': 'Blanco y negro',
        'logo_black_white_off': 'Color',
        'logo_circular': 'El logotipo de la tesis es circular',
        'logo_circular_on': 'Circular',
        'logo_circular_off': 'No circular',
        
        # ========== Botones de acción ==========
        'refresh': 'Limpiar página',
        ...
        # ========== Guía de inicio ==========
        'welcome_message': '''En el nombre de Dios, el Clemente, el Misericordioso
Bienvenido al programa Creador de Portadas
Para crear cualquier tipo de portada, haga clic en el botón correspondiente''',
        
        # ========== Acerca de nosotros ==========
        'about_us': '''📱 Programa Creador de Portadas

Desarrolladores: Sres. Moghiseh y Shaker

📅 Versión: ۱.۰.۰

📧 Soporte: support@example.com

📞 Teléfono: ۰۲۱-۱۲۳۴۵۶۷۸

⭐ Este programa está diseñado para crear varios tipos de portadas.

❤️ Gracias por su elección''',
    }
}
